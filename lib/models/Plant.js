...
module.exports = class Plant {
    ...
    static async insert({ plant_name, description, scientific_name, image, category_id, userId, on_market, price }) {
        const { rows } = await pool.query(
            `INSERT INTO plants (plant_name, description, scientific_name, image, category_id, users_id, on_market, price)
            VALUES ($1, $2, $3, $4, $5, $6, $7, $8)
            RETURNING *
            `,
            [plant_name, description, scientific_name, image, category_id, userId, on_market, price]
        );
    ...
    static async updatePlantById(plantId, userId, {plant_name, description, scientific_name, image, category_id, on_market, price}) {
        ...
        const { rows } = await pool.query(
            ...
            [plant_name, description, scientific_name, image, category_id, on_market, price, plantId, userId]
        );
